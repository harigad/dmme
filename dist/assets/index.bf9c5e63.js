...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web.90e32642.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
const Camera = registerPlugin("Camera", {
  web: () => __vitePreload(() => import("./web.7b665e98.js"), true ? [] : void 0).then((m) => new m.CameraWeb())
});
const Voip = registerPlugin(
  "Voip"
);
